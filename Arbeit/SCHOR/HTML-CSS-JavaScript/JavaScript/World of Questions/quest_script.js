   ...
   var rAntwort = 0;                   // Anazhl richtiger Antworten
   var Bewertung = " ";               // Bewertung  
   var ZeitS = 0;                  // Startzeit
   var ZeitE = 0;                  // Endzeit
   var aufgaben = new Array();        // Array für die Fragestellungen
   var antwort = new Array();      // Array für die Antworten

   antwort = [1,1,3,1,1,1,3,1,2,3,2,2,3,1,1,2,1,1,1,2,1,1];           //Antworten der Fragen 0 bis 22
       ...
       aufgaben[2][0] = "3.Frage"; aufgaben[2][1] = "Welches Betriebssystem gibt es nicht?";
       ...
       aufgaben[4][0] = "5.Frage"; aufgaben[4][1] = "Wie groß kann eine 'bigInt' in JavaScript sein?";
       ...
       aufgaben[7][2] = "Ja"; aufgaben[7][3] = "Weiß ich nicht"; aufgaben[7][4] = "Nein";

       aufgaben[8][0] = "9.Frage"; aufgaben[8][1] = "Welches BOM ist in HTML-Dateien erlaubt?";
       aufgaben[8][2] = "Big-Endian";  aufgaben[8][3] = "Keines"; aufgaben[8][4] = "Little-Endian";

       aufgaben[9][0] = "10.Frage"; aufgaben[9][1] = "1 Zoll = ";
       ...
       aufgaben[14][2] = "Cascade Style Sheet"; aufgaben[14][3] = "Computer System Service"; aufgaben[14][4] = "Compiler Sequence Styler";

       aufgaben[15][0] = "16.Frage"; aufgaben[15][1] = "Mit welchen Zahlen rechnet ein Computer?";
       ...
       aufgaben[18][0] = "19.Frage"; aufgaben[18][1] = "RGB steht für....?";
       aufgaben[18][2] = "Red-Blue-Green";  aufgaben[18][3] = "Residence Gigabit"; aufgaben[18][4] = "Royal Green Barets";

       aufgaben[19][0] = "20.Frage"; aufgaben[19][1] = "Ist sKGB eine Farbpalette?";
...
function endsequenz()
{                
     ZeitE = performance.now();                                        // Festellung Endzeit                      
     xpunkte();                                                        // Spiel ist Aus, es wird nur das Ergebnis angezeigt
     if (punkte <= 190) {Bewertung = "Leider nicht so gut";}                                                //}
     else if (punkte == 330) {Bewertung = "Hälfte der Fragen richtig beantwortet";}                         //}
     else if(punkte <= 400 && punkte > 330) {Bewertung = "Gut";}                                            //}
     else if (punkte > 400 && punkte < 550) {Bewertung = "Sehr Gut";}                                       //} Überprüft die Punktezahl und weißt Bewertung den richtigen Wert zu
     else if (punkte >= 550) {Bewertung = "Ausgezeichnet";}                                                 //}
     else if (punkte == 660) {Bewertung = "Alle fragen richtig beantwortet, volle Punktzahl!"}              //}
     ...
     document.getElementById("a2").innerHTML = "Die Antworten wahren " + Bewertung;
     document.getElementById("a3").innerHTML = "Richtige Antworten: " + rAntwort;
     document.getElementById("zeit").innerHTML = "Ihre Zeit: " + ((ZeitE - ZeitS) / 1000).toFixed(2) + " sek";
