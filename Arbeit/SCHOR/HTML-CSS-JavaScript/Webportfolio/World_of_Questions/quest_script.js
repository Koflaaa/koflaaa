   ...
   var punkte = 0;                 // Anzahl der erreichten Punkte
   ...
   var richtigeAntwort = 0;        // Anzahl richtiger Antworten
   var falscheAntwort = 0;		   // Anzahl falscher Antworten
   ...
   antwort = [1,1,3,1,1,1,3,1,3,3,2,2,3,1,1,2,1,1,1,2,1,1];           // Antworten der Fragen 1 bis 21
     ...
     aufgaben[0][0] = "1.Frage"; aufgaben[0][1] = "Ist C# objektorientiert?";
     ...
     aufgaben[4][2] = "Bis zu Arbeitsspeichergröße";  aufgaben[4][3] = "Ca. 100 mal so groß wie double in C#"; aufgaben[4][4] = "Gibt's doch gar nicht"
     ...
     aufgaben[7][0] = "8.Frage"; aufgaben[7][1] = "Ist HTML eine Auszeichnungssprache?";
     ...
     aufgaben[11][2] = "Zirkus Clowns";  aufgaben[11][3] = "Creative Commons"; aufgaben[11][4] = "Computer Cluster";
     ...
     aufgaben[18][2] = "Red-Green-Blue";  aufgaben[18][3] = "Residence Gigabit"; aufgaben[18][4] = "Royal Green Berets";
     ...
     aufgaben[21][2] = "ffffff"; aufgaben[21][3] = "eeeeee"; aufgaben[21][4] = "cccccc";
     ...
     function pfg(k)
     {
          ...
          if (nummer > 0) {                                                 // Erst wenn die erste Frage beantwortet wurde
               xpunkte();}                            
          nummer += 1;                                                      // Nummer der nächsten Frage die kommt
          StartA = performance.now();                                       // Feststellung Startzeit
          if (nummer > fragen - 1) {ende = 1;}                              // Nummer darf nicht die Anzahl der Fragen übersteigen
     }

     function endsequenz()
     {                
          Endzeit = performance.now();                                      // Feststellung Endzeit                      
		  ...
		  document.getElementById("a3").innerHTML = "Falsche Antworten: " + falscheAntwort;
