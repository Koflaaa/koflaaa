   ...
   antwort = [1,1,3,1,1,1,3,1,2,3,2,2,3,1,1,2,1,1,1,2,1,1];           //Antworten der Fragen 1 bis 21
     ...
     {                
          ...
          if (punkte < 330) {Bewertung = "leider nicht so gut";}                                                 //}
          else if (punkte == 330) {Bewertung = "zur Hälfte richtig beantwortet!";}                               //}
          ...
          else if (punkte == 660) {Bewertung = "alle richtig! Volle Punktezahl!"}                                //}
          ...
          document.getElementById("a2").innerHTML = "Die Antworten waren " + Bewertung;
          document.getElementById("a3").innerHTML = "Richtige Antworten: " + richtigeAntwort;
